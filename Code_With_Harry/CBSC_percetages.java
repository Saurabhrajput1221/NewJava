...
public class CBSC_percetages {
    public static void main(String[] args) {
        ...
        System.out.println("Fill your Maths mark...");
        float Math = sc.nextInt();

        System.out.println("Fill your Phy mark...");
        float Phy = sc.nextInt();

        System.out.println("Fill your Che mark...");
        float Che = sc.nextInt();

        System.out.println("Fill your Eng mark...");
        float Eng = sc.nextInt();

        System.out.println("Fill your His mark...");
